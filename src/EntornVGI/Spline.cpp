...
void Spline::Draw(bool cp, int res, SPLINE_TYPES s)
{
	if (cp)
	{
		glColor3f(5, 0.7, 1);
...
Vector3 Spline::GetPosition(float p, SPLINE_TYPES s) // (0-1)
{
...
Vector3 Spline::GetDirection(float p, SPLINE_TYPES s)
{
	float partialDist = m_distance * p; // dist to p
