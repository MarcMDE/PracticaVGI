...
// Entorn VGI: Variables de control de menú d'Escences
	char escena; // a
...
public:
	...
	afx_msg void OnPracticaCotxe();
	afx_msg void OnUpdatePracticaCotxe(CCmdUI *pCmdUI);
